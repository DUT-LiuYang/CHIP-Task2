...
class DRCN_GRUCell(Layer):
    print("call DRCN_GRUCeLL")
    ...
    def __init__(self, units,
                 ...
                 reset_after=False,
                 **kwargs):
        super(DRCN_GRUCell, self).__init__(**kwargs)
        self.units = units
    ...
    def get_config(self):
        ...
        base_config = super(DRCN_GRUCell, self).get_config()
...
class DRCN_GRU(RNN):
    ...
    def __init__(self, units,
        ...
        super(DRCN_GRU, self).__init__(cell,
    ...
    def call(self, inputs, mask=None, training=None, initial_state=None):
        ...
        return super(DRCN_GRU, self).call(inputs,
                                     mask=mask,
                                     training=training,
    ...
    def get_config(self):
        config = {'units': self.units,
                  ...
                  'implementation': self.implementation,
                  'reset_after': self.reset_after}
        base_config = super(DRCN_GRU, self).get_config()
